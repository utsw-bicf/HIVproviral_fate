...
scanMotifGenomeWide.pl output.motif /project/shared/bicf_workflow_ref/human/GRCh38/genome.fa -bed | awk 'BEGIN {OFS="\t"}; {print $1, $8, $9, $10}' >/project/BICF/BICF_Core/shared/Projects/Dorso/Chromatin_organization/damIDseq/GATC_sites.bed
