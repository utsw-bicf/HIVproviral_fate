...
write.table(LB, file=("LaminB_negative_PC1_kmeans_2.txt"), quote = F, col.names = F, row.names = F, sep = "\t")
...
write.table(LB, file=("LaminB_negative_PC1_kmeans_5.txt"), quote = F, col.names = F, row.names = F, sep = "\t")
