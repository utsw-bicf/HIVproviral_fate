...
makeTagDirectory HicHomerTagDir/ GSM3489136_1.sam,GSM3489136_2.sam -tbp 1 -genome hg38 -checkGC -restrictionSite GATC -removePEbg -removeSpikes 10000 5
makeTagDirectory HicHomerTagDir/ GSM3489137_1.sam,GSM3489137_2.sam -tbp 1 -genome hg38 -checkGC -restrictionSite GATC -removePEbg -removeSpikes 10000 5
