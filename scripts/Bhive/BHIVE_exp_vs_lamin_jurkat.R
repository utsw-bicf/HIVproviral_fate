...
### Load Lamin; 5 states plus NA
Lamin <- read.table(file="/project/BICF/BICF_Core/shared/Projects/Dorso/Chromatin_organization/HOMER/std_HicHomerTagDir/lib1_lib2_merged/Jurkat_PC1withKmeans_Lamin.bed", header=F, sep='\t')
