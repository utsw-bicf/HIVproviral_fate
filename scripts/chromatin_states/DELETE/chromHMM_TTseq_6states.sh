...
mkdir /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary
java -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar BinarizeBam \
  ...
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary
...
java -Djava.awt.headless=true -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar LearnModel \
  -init random \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/state_6 \
  6 \
  hg38 
...
java -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar BinarizeBam \
  ...
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary_forward

unset DISPLAY
java -Djava.awt.headless=true -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar LearnModel \
  -init random \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary_forward \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/state_6_forward \
  6 \
  hg38 
...
java -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar BinarizeBam \
  ...
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary_reverse

unset DISPLAY
java -Djava.awt.headless=true -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar LearnModel \
  -init random \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/binary_reverse \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/enhancer_database/six_state_chromHMM_TTseq/state_6_reverse \
  6 \
  hg38
