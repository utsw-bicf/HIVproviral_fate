...
### Annotate states
### BELOW didn't work
#mkdir /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/chromHMM/OverlapEnrichment
#unset DISPLAY
#java -Djava.awt.headless=true -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar OverlapEnrichment \
#  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/chromHMM/allbam_learn15/jurkat_15_segments.bed \
#  /work/BICF/s185797/programs/ChromHMM/COORDS/hg38 \
#  OverlapEnrichment/overlap_all15
###
...
### Split the files into overlapping beds by their state
#mkdir /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/chromHMM/known_state_bedfiles/E115
#perl -p -e 's|8_ZNF\/Rpts|8_ZNF_Rpts|g' E115_15_coreMarks_hg38lift_mnemonics.bed >test.bed
#states='10_TssBiv 11_BivFlnk 12_EnhBiv 13_ReprPC 14_ReprPCWk 15_Quies 1_TssA 2_TssAFlnk 3_TxFlnk 4_Tx 5_TxWk 6_EnhG 7_Enh 8_ZNF 9_Het'
#for state in ${states}; do
#grep ${state}  E115_15_coreMarks_hg38lift_mnemonics.bed | awk 'BEGIN {OFS="\t"}; {print $1, $2, $3}'>/project/BICF/BICF_Core/shared/Projects/Dorso/#chromatin_states/chromHMM/known_state_bedfiles/E115/E115_${state}.bed
#done

mkdir /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/chromHMM/OverlapEnrichment_E115
unset DISPLAY
java -Djava.awt.headless=true -jar /work/BICF/s185797/programs/ChromHMM/ChromHMM.jar OverlapEnrichment \
  /project/BICF/BICF_Core/shared/Projects/Dorso/chromatin_states/chromHMM/allbam_learn15/jurkat_15_segments.bed \
